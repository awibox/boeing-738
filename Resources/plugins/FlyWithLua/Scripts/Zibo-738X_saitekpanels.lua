if (PLANE_ICAO == "B737" or PLANE_ICAO == "B738" or PLANE_ICAO == "B739") and (XPLMFindDataRef("laminar/B738/engine/indicators/N2_percent_1")) then
    ...
    function Init_Loop()
        ...
        if MultiPanel then
            ...
            dataref("MCP_CMD_A_STATUS", "laminar/B738/EFIS/baro_set_std_pilot", "readonly")
            ...
            dataref("MCP_HDGHOLD_STATUS", "sim/cockpit/switches/EFIS_shows_weather", "readonly")
            dataref("MCP_HDGBUG_STATUS", "sim/cockpit/switches/EFIS_shows_weather", "readonly")
            dataref("MCP_LNAV_STATUS", "laminar/B738/EFIS/EFIS_airport_on", "readonly")
            dataref("MCP_N1_STATUS", "laminar/B738/EFIS/EFIS_airport_on", "readonly")
            dataref("MCP_SPEED_STATUS", "sim/cockpit2/EFIS/EFIS_page", "readonly", 6)
    ...
    create_command("FlyWithLua/B738/Cmd_HC_Gear_Off", "Cmd_HC_Gear_Off", "Cmd_HC_Gear_Off()", "", "")
    ...
    create_command("FlyWithLua/B738/Cmd_OT_Gen_Off", "Cmd_OT_Gen_Off", "Cmd_OT_Gen_Off()", "", "")
    ...
    -- HDG
    function Cmd_MP_HDG()
        CommandBegin("laminar/B738/EFIS_control/capt/push_button/wxr_press")
    end
    ...
    -- NAV
    function Cmd_MP_NAV()
        CommandBegin("laminar/B738/EFIS_control/capt/push_button/arpt_press")
    end
    ...
    -- VS
    function Cmd_MP_VS()
        CommandBegin("laminar/B738/toggle_switch/fuel_flow_up", 1)
    end
    ...
    function RefreshLights()
        ...
        if MultiPanel then
            ...
            -- AT
            if MULTI_AT_SWITCH == 1 and AuthoThrottleOn == false then
                command_once("laminar/B738/toggle_switch/cockpit_dome_dn")
                command_once("laminar/B738/toggle_switch/cockpit_dome_dn")
                AuthoThrottleOn = true
            elseif MULTI_AT_SWITCH == 0 and AuthoThrottleOn == true then
